...
START_TEST (test_call_get_PublicFolderID) {
	...
	CHECK_SUCCESS(openchangedb_get_PublicFolderID(oc_ctx, 1234, &folder_id));
...
START_TEST(test_call_get_PublicFolderReplica) {
	...
	CHECK_SUCCESS(openchangedb_get_PublicFolderReplica(oc_ctx, &ReplID, &ReplGUID));
...
START_TEST(test_call_get_mapistoreURI) {
	...
	CHECK_SUCCESS(openchangedb_get_mapistoreURI(mem_ctx, oc_ctx, "mail_user", FOLDER_ID_EXPECTED, &mapistoreURL, true));
...
START_TEST(test_call_get_ReceiveFolder) {
	...
	CHECK_SUCCESS(openchangedb_get_ReceiveFolder(mem_ctx, oc_ctx, "recipient", "MessageClass", &fid, ExplicitMessageClass));
